...
import brainmateapp.service.ContactService;
...
public class KontakFrame extends JInternalFrame {
    ...
    private void loadAll() {
        ...
        for (Contact c : ContactService.getAll()) {
            m.addRow(new Object[]{
               c.getId(), c.getCustomerId(), df.format(c.getDate()), c.getDetail()
            });
        }
    }
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {
        ExportUtil.exportTableToCSV(tblKontak,
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            ...
            int cid = Integer.parseInt(JOptionPane.showInputDialog(this,
                  "Cust ID:", m.getValueAt(sel,1)));
            String s = JOptionPane.showInputDialog(this,
                  "Tanggal (yyyy-MM-dd):", m.getValueAt(sel,2));
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(s);
            String d = JOptionPane.showInputDialog(this,
                  "Detail:", m.getValueAt(sel,3));
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(JOptionPane.showConfirmDialog(this,
           "Hapus kontak ini?","Konfirmasi", JOptionPane.YES_NO_OPTION)
